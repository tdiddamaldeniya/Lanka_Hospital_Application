...
$(document).ready(function() {
    ...
    $.getJSON(patientAPI).done(function(patient) {
       ...
       $("#last-name-disabled").attr("placeholder", patient["GuardianName"]);
       $("#Nic-disabled").attr("placeholder", patient["Nic"]);
       $("#Address-disabled").attr("placeholder", patient["Address"]);
       ...
       $("#patient-Stage").html(patient["Stage"]);
